...
warning off
RectRight = 3;
origPath = 'C:\Users\Felix\Desktop\Program\ASPAnalyze';
timePlot = 1;
plotData = [];
...
for n = 1:4
    uicontrol('Style','text','String',plotName{n},'Visible','on','units','normalized','Position', [0.70+n/20 0.95 0.05 0.025]);
end
